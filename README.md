...
I used a CNN model to recognize the initial handful numbers on the board, then used contours to find the coordination of them on the board.
...
2. Thresh_amount.  
If the image has black lines, the tresh_amount should take the amount of 200. And if the image has light gray lines, the tresh_amount should take the amount of 240 or 250.
